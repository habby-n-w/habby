            ...
            <div className='flex flex-col items-center justify-center'>
              {timer > 0 ? (
                <div className="flex flex-col items-center justify-center gap-5">
                  <div className=" h-80 w-80 rounded-full text-center flex items-center justify-center p-20 text-7xl font-semibold bg-purpleapp shadow-xl shadow-purple-300 text-white">{formatTimer(timer)}</div>
                  <button
